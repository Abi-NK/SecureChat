...
public class ModularExpSpeed {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      BigMath three = new BigMath(128, new Random());
      long startTime3 = System.nanoTime();      
      one = mdx.modPower(one, two, three);
      ...
      BigInteger three1 = new BigInteger(three.toRawString());
      long startTime4 = System.nanoTime();
      one1 = one1.modPow(two1, three1);
    ...
    for (int i = 0; i < 100; i++) {
      ...
      BigMath three = new BigMath(256, new Random());
      long startTime3 = System.nanoTime();      
      one = mdx.modPower(one, two, three);
      long endTime3 = System.nanoTime();
      long duration3 = (endTime3 - startTime3);
    ...
    for (int i = 0; i < 100; i++) {
      ...
      BigMath three = new BigMath(512, new Random());
      long startTime3 = System.nanoTime();      
      one = mdx.modPower(one, two, three);
      long endTime3 = System.nanoTime();
      long duration3 = (endTime3 - startTime3);
    ...
    for (int i = 0; i < 100; i++) {
      ...
      BigMath three = new BigMath(1024, new Random());
      long startTime3 = System.nanoTime();      
      one = mdx.modPower(one, two, three);
      long endTime3 = System.nanoTime();
      long duration3 = (endTime3 - startTime3);
    ...
    for (int i = 0; i < 100; i++) {
      ...
      BigMath three = new BigMath(2048, new Random());
      long startTime3 = System.nanoTime();      
      one = mdx.modPower(one, two, three);
      long endTime3 = System.nanoTime();
      long duration3 = (endTime3 - startTime3);
    ...
    for (int i = 0; i < 100; i++) {
      ...
      BigMath three = new BigMath(4096, new Random());
      long startTime3 = System.nanoTime();      
      one = mdx.modPower(one, two, three);
      long endTime3 = System.nanoTime();
      long duration3 = (endTime3 - startTime3);
